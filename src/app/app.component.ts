...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.meta.updateTag({
      name: 'description',
      content: 'Slovenská ľudová majolika z Modry – originálna ručne maľovaná keramika, tradičné vzory a remeselné výrobky. Objavte hrnčeky, misy, taniere a dekorácie priamo z dielne v Modre.'
    });

    // Dynamický SEO podľa route.data['title'] / ['description']
    this.router.events
  ...
  // Pomocná metóda: nájde najhlbšie dieťa aktuálnej route kvôli SEO dátam
